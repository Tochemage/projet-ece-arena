...
void initAllegro()
{
    ...
    set_window_title("CRYPTOPOLY"); // nom de program
    install_keyboard();
    install_mouse();
    set_color_depth(16);
...
void saisieLesNoms(int w,int h,int nbj, t_sauvegarde * partie,BITMAP* menuScreen )
{
    ...
    for(int i=0; i<nbj; i++)
    {
        ...
        if(nbj==2)
        {
            textout_ex (menuScreen,font1,"Saisir le nom",x-190,y+120,makecol(253,108,158),makecol(255,255,255));

        }

        else if(nbj==3)
        {
            textout_ex (menuScreen,font1,"Saisir le nom",x-190,y+110,makecol(253,108,158),makecol(255,255,255));

        }

        else if(nbj==4)
        {
            textout_ex (menuScreen,font1,"Saisir le nom",x-190,y+90,makecol(253,108,158),makecol(255,255,255));
        ...
        while(!enterClicked)
        {
            ...
            else
            {
                ...
                if (nbj==2)
                {
                    textout_ex (menuScreen,font1,nom,x+60,y+120,makecol(253,108,158),makecol(255,255,255));
                }
                else if (nbj==3)
                {
                    textout_ex (menuScreen,font1,nom,x+60,y+120,makecol(253,108,158),makecol(255,255,255));
                ...
                {
                    textout_ex (menuScreen,font1,nom,x+60,y+80,makecol(253,108,158),makecol(255,255,255));
                }
            ...
            textout_ex (menuScreen,font,"Appuyer sur entree pour valider",60,1030,makecol(50,255,38),makecol(176,176,176));
            blit(menuScreen,screen,0,0,0,0,w,h);
        }
